...
func _ready():
	...
	var err = server.listen(12345, "127.0.0.1")
	if err == OK:
	...
	Global.connect("pressedKey",_on_background_input_capture_bg_key_pressed)
	#Input.is_joy_button_pressed()
	#Input.connect("joy_button_down", "changeCostumeStreamDeck")
...
func _input(event):
	if event.is_action_pressed("Emote_1"):
		changeCostumeStreamDeck("1")
	elif event.is_action_pressed("Emote_2"):
		changeCostumeStreamDeck("2")
	elif event.is_action_pressed("Emote_3"):
		changeCostumeStreamDeck("3")
	elif event.is_action_pressed("Emote_4"):
		changeCostumeStreamDeck("4")
	elif event.is_action_pressed("Emote_5"):
		changeCostumeStreamDeck("5")
	elif event.is_action_pressed("Emote_6"):
		changeCostumeStreamDeck("6")
	elif event.is_action_pressed("Emote_7"):
		changeCostumeStreamDeck("7")
	elif event.is_action_pressed("Emote_8"):
		changeCostumeStreamDeck("8")
	elif event.is_action_pressed("Emote_9"):
		changeCostumeStreamDeck("9")
	elif event.is_action_pressed("Emote_10"):
		changeCostumeStreamDeck("10")
	
	
func _on_background_input_capture_bg_key_pressed(node, keys_pressed):
	var keyStrings = []
	
	print("on_bg_input_capture")
	Global.pushUpdate("on_background_input pressed")
	
	for i in keys_pressed:
		if keys_pressed[i]:
			print(OS.get_keycode_string(i))
...
func bgInputSprite(node, keys_pressed):
	...
	print("bgInputSprite")
	Global.pushUpdate("bgInputSprite")
